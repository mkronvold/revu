...
| [`docs/CI.md`](docs/CI.md)                         | PR validation commands, container SBOM/scan policy, and Node alignment rules.           |
| [`docs/DOCKER.md`](docs/DOCKER.md)                 | `up.sh` / `down.sh` / `autoupdate.sh` operator behavior and deploy channels.            |
...
| [`security/exceptions.md`](security/exceptions.md) | Time-boxed security finding exceptions with owner and expiry.                           |
