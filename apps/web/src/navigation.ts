import {
  ...
  type WorkflowVisibility as SharedWorkflowVisibility,
} from '@revu/contracts';
...
export const routeLegend = {
  dashboard:
    'Dashboard is the single workflow action surface for authored assessments, manager follow-up, reviewer work, and admin oversight.',
  assessments:
    'Assessments are employee-authored forms that staff complete before any review work begins.',
} as const;
...
export const appSections: AppSection[] = [
  {
    ...
    title: 'Dashboard',
    summary:
      'The shared operational surface for employee assessment work, due dates, submissions, and role-based workflow actions.',
    ...
    placeholderDescription:
      'Dashboard sections keep authored assessment queues, manager actions, reviewer follow-up, and admin oversight together.',
    nextSlice:
      'Continue wiring the dashboard sections to the remaining scheduling and reviewer conclusion workflows.',
  },
  {
    id: 'employees',
    path: '/employees',
    ...
    placeholderDescription:
      'The shell provides a roster placeholder, filters, and a detail surface for future employee profile actions.',
    nextSlice:
      'Introduce list/detail state and connect employee records once the domain slice is implemented.',
  },
  {
    id: 'questions',
    path: '/questions',
    ...
    placeholderDescription:
      'Future work will add editors for active and archived question sets, plus import and export utilities.',
  ...
  },
  {
    ...
    title: 'Assessments',
    summary:
      'Admin-only visibility into every assessment in the active review period, separate from the dashboard workflow sections.',
    audience: ['Admin'],
    highlights: [
    ...
    placeholderDescription:
      'This route will show all active-period assessments with subject, assessor, and status details.',
  ...
  },
  {
    ...
    title: 'Review Period',
    summary:
      'Admin-only controls for review-period activation, editing, archive state, and lifecycle management.',
    audience: ['Admin'],
    highlights: [
    ...
    placeholderDescription:
      'This route hosts review-period summaries, editing, activation, and lifecycle operations for admins.',
    nextSlice:
      'Keep review-period lifecycle controls here as the broader admin workflow continues to expand.',
  },
  {
    id: 'fileManagement',
    ...
    summary:
      'Admin import, export, and backup operations live here without mixing in review-period lifecycle management.',
    audience: ['Admin'],
    highlights: [
    ...
    placeholderDescription:
      'This route hosts the transfer and backup tools while review-period lifecycle actions stay on their own admin page.',
    nextSlice:
      'Finish consolidating the remaining import and export workflows into the shared file management route.',
  },
  {
    id: 'workflow',
    path: '/workflow',
    ...
    title: 'Workflow',
    summary:
      'Reference the current lifecycle from review-period setup through submission, acceptance, meeting readiness, scheduling, conclusion, and archive.',
    audience: ['Employee', 'Manager', 'Admin'],
    highlights: [
    ...
    placeholderDescription:
      'This route renders the complete workflow markdown and keeps it accessible from the main sidebar navigation.',
    nextSlice:
      'Add deeper links from each workflow step once the destination views are fully implemented.',
  },
];
...
const appSectionByPath = new Map<string, AppSection>(
  appSections.map((section) => [section.path, section]),
);
