...
const themePalettes: Record<Exclude<ThemePreference, 'light'>, ThemePalette> = {
  ...
  'summer-nights': {
    appText: '#2d1810',
    loginBackground:
      'radial-gradient(circle at top, rgba(251, 146, 60, 0.28), transparent 28%), linear-gradient(180deg, #fef3e2 0%, #fde9cc 42%, #f4d4a8 100%)',
    appBackground:
      'radial-gradient(circle at top, rgba(249, 115, 22, 0.22), transparent 30%), linear-gradient(180deg, #fef3e2 0%, #fde9cc 46%, #f9ddb8 100%)',
    surfaceText: '#2d1810',
    surfaceBorder: 'rgba(180, 83, 9, 0.26)',
    surfaceBackground: 'rgba(193, 243, 232, 0.85)',
    surfaceShadow: '0 18px 46px rgba(146, 64, 14, 0.16)',
    mutedText: '#7c4d2b',
    sidebarBackground: 'rgba(234, 149, 102, 0.88)',
    sidebarText: '#2d1810',
    navText: '#2d1810',
    navBorder: 'rgba(20, 184, 166, 0.22)',
    navBackground: 'rgba(153, 246, 228, 0.24)',
    navHoverBorder: 'rgba(13, 148, 136, 0.45)',
    navHoverBackground: 'rgba(94, 234, 212, 0.32)',
    navActiveBorder: 'rgba(20, 184, 166, 0.72)',
    navActiveBackground: 'rgba(204, 251, 241, 0.45)',
    sidebarNoteBackground: 'rgba(251, 146, 60, 0.22)',
    badgeText: '#2d1810',
    badgeBackground: 'rgba(251, 207, 232, 0.72)',
    pillText: '#2d1810',
    pillBackground: 'rgba(249, 168, 212, 0.55)',
    inputText: '#2d1810',
    inputBorder: 'rgba(245, 158, 11, 0.26)',
    inputBackground: 'rgba(255, 247, 237, 0.95)',
    primaryButtonText: '#fefcfb',
    primaryButtonBorder: 'rgba(249, 115, 22, 0.3)',
    primaryButtonStart: '#14b8a6',
    primaryButtonEnd: '#f472b6',
    secondaryButtonText: '#2d1810',
    secondaryButtonBorder: 'rgba(217, 119, 6, 0.3)',
    secondaryButtonBackground: 'rgba(254, 243, 226, 0.96)',
    successText: '#14532d',
    successBackground: 'rgba(187, 247, 208, 0.65)',
    errorText: '#7f1d1d',
    errorBackground: 'rgba(254, 202, 202, 0.75)',
    modalBackdrop: 'rgba(45, 24, 16, 0.36)',
    activeBorder: 'rgba(249, 115, 22, 0.42)',
    activeBackground: 'rgba(255, 237, 213, 0.78)',
    noteBackground: 'rgba(165, 243, 252, 0.42)',
    noteText: '#115e59',
  },
  'winter-nights': {
    appText: '#e2e8f0',
...
const themedMutedTextSelectors = [
  ...
  '.status-caption',
  '.brand-copy',
  '.employee-row-summary small',
  '.employee-row-summary span',
  '.stack-form label',
  '.inline-field',
  '.detail-grid dt',
  '.ia-item span',
