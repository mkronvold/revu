...
const themePalettes: Record<Exclude<ThemePreference, 'light'>, ThemePalette> = {
  ...
  'summer-nights': {
    ...
    surfaceText: '#2d1810',
    surfaceBorder: 'rgba(180, 83, 9, 0.28)',
    surfaceBackground: 'rgba(162, 204, 194, 0.82)',
    ...
    inputBackground: 'rgba(242, 228, 212, 0.94)',
    ...
    secondaryButtonBackground: 'rgba(232, 214, 192, 0.95)',
    successText: '#14532d',
    ...
    activeBackground: 'rgba(232, 208, 186, 0.82)',
