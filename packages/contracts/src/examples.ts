...
const timestamps = {
  ...
  readyForMeeting: '2026-02-18T15:30:00.000Z',
  scheduled: '2026-02-20T10:00:00.000Z',
  reviewer1Completed: '2026-02-24T09:15:00.000Z',
  reviewer2Completed: '2026-02-24T10:45:00.000Z',
  concluded: '2026-02-24T10:45:00.000Z',
...
export const employeesListExample: EmployeesListResponse = {
  items: [adaAdminEmployee, mannyManagerEmployee, elliotEmployee, patPeerEmployee],
};
  ...
  items: [
    {
      ...
      footerMarkdown: 'Submit when you are ready for manager or admin acceptance.',
      questions: [
        {
  ...
  items: [
    {
      ...
      readyForMeetingAt: timestamps.readyForMeeting,
      managerNotes: 'Accepted and queued for the review meeting.',
      scheduledAt: timestamps.scheduled,
      scheduledByEmployeeId: '11111111-1111-4111-8111-111111111111',
      reviewer1Notes: null,
    ...
    },
    {
      ...
      acceptedByEmployeeId: '22222222-2222-4222-8222-222222222222',
      readyForMeetingAt: timestamps.readyForMeeting,
      managerNotes: 'Peer feedback accepted and queued for the review meeting.',
      scheduledAt: timestamps.scheduled,
      scheduledByEmployeeId: '11111111-1111-4111-8111-111111111111',
      reviewer1Notes: null,
      reviewer1CompletedAt: null,
    ...
    },
    {
      ...
      readyForMeetingAt: timestamps.readyForMeeting,
      managerNotes: 'Archived after both reviewers concluded.',
      scheduledAt: timestamps.scheduled,
      scheduledByEmployeeId: '11111111-1111-4111-8111-111111111111',
      reviewer1Notes: 'Ada highlighted sustained delivery and long-term impact.',
      reviewer1CompletedAt: timestamps.reviewer1Completed,
      reviewer1CompletedByEmployeeId: '11111111-1111-4111-8111-111111111111',
      reviewer2Notes: 'Manny confirmed the follow-up goals from the review meeting.',
      reviewer2CompletedAt: timestamps.reviewer2Completed,
      reviewer2CompletedByEmployeeId: '22222222-2222-4222-8222-222222222222',
      concludedAt: timestamps.concluded,
      concludedByEmployeeId: '22222222-2222-4222-8222-222222222222',
      reviewedAt: timestamps.concluded,
...
export const domainRulesExample: DomainRulesResponse = {
  ...
  assessmentSchedulingIsStatusOnly: true,
  reviewerCommentsLiveOnAssessments: true,
  allReviewersMustConcludeBeforeFullyConcluded: true,
  reviewersDistinctFromReviewee: true,
  reviewersMayOverlapManagerOrAssessor: true,
